...
:END:
   The aim here is to inform another author of your public repository,
   what they can find there and what they should do to pull those
   changes into their own repository. The way to do this:

   - Push all the changes to your public repository, preferably in a
     well-named branch.
...
# Selectively copy a file from a different branch into the current
# branch
